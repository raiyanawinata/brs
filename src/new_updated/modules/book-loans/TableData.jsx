...
export default function TableData({ data }) {
    ...
    return (
        <div className="table-responsive">
            {selectedBook ? (
                <Top10BookRecommendedByTitle bookselected={selectedBook} recommendations={recommendations} onBack={() => setSelectedBook(null)} />
            ) : (
                <>
                    <div className="mb-3 d-flex justify-content-between align-items-center">
                        <div>
                        ...
                        <tbody>
                            {ResultData.map((v, index) => (
                                <tr key={index}>
                                    ...
                                    <td>{v.total_peminjam}</td>
                                    <td>
                                        <button className="btn btn-icon btn-sm btn-light" type="button" onClick={() => fetchRecommendations(v)}>
                                            <i className="bi bi-search"></i>
                                        </button>
                                    </td>
                                </tr>
